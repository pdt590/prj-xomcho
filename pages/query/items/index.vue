                    ...
                    <b-tab-item>
                        ...
                        <div class="level">
                            <div class="level-item">
                                <button class="button is-rounded is-outlined" :class="{'is-loading': queryLoading}" :disabled="!loadedItems.length" @click="onLoad"> Xem thêm</button>
                            </div>
                        </div>
                    </b-tab-item>
                </b-tabs> 
    ...
    export default {
        ...
        async asyncData({ store, params, error }) {
            try {
                ...
                error({ statusCode: 500, message: 'Lỗi loadAllItems' })
            }
        },
        methods: {
            async onLoad() {
