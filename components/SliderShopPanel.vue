    ...
    <section>
        <div class="w3-display-container w3-center">
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/220/?image=16" alt="Image 1" style="width: 200%;">
            ...
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/200/?image=17" alt="Image 2" style="width: 200%;">
                <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
                    <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large ">
            ...
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/200/?image=18" alt="Image 3" style="width: 200%;">
                <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
                    <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large ">
