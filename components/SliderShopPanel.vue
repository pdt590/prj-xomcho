<template>
    <section>
        <div class="w3-display-container w3-center">
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/150/?image=16" alt="Image 1" style="width: 150%;">
                <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
                    <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
                        <h1 class="w3-xlarge">Take photos with our app</h1>
                        <hr class="w3-opacity">
                        <p>Super simple installment: free of charge</p>
                        <p><button class="w3-button w3-block w3-blue w3-round" @click="document.getElementById('download').style.display='block'">Download <i class="fa fa-android"></i> <i class="fa fa-apple"></i> <i class="fa fa-windows"></i></button></p>
                    </div>
                </div>
            </div>
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/150/?image=17" alt="Image 2" style="width: 150%;">
                <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
                    <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
            ...
            <div class="shop-panel w3-animate-opacity">
                <img class="w3-image" src="https://picsum.photos/600/150/?image=18" alt="Image 3" style="width: 150%;">
                <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
                    <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
...
<script>
    ...
    export default {
        ...
        methods: {
            showDivs(n) {
                let i 
                let x = document.getElementsByClassName("shop-panel")
