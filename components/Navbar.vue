                    ...
                    <div class="navbar-start">
                        <div class="navbar-item has-dropdown is-hoverable">
                            ...
                            <div class="navbar-dropdown">
                                <b-collapse  v-for="(type, i) in types" :key="i" :to="`/query/${type.en}`">
                                    <nuxt-link class="navbar-item" :to="`/query/${type.en}`" slot="trigger">
                                        #{{type.vi}}
                                    </nuxt-link>
                                    <a class="navbar-item">
                                        Lorem ipsum dolor,
                ...
                <div class="navbar-menu">
                    <div class="navbar-start">
                        ...
                        <div class="navbar-item has-dropdown is-hoverable">
                            ...
                            <div class="navbar-dropdown">
                                <div class="columns">
                                    <div class="column" v-for="(type, i) in types.slice(0,9)" :key="i" :to="`/query/${type.en}`">
                        ...
                        <a href="" class="navbar-item" >Cửa hàng của bạn</a>
                        <a href="" class="navbar-item" >Sản phẩm của bạn</a>
                    </div>
