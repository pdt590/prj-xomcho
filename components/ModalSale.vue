                    ...
                    <section class="modal-card-body" >
                        ...
                        <b-field label="Số lượng*"
                            ...
                            <b-field>
                                ...
                                <p class="control">
                                    <span class="button is-static">{{$options.filters.fmPrice(formData.unit*itemData.price)}} {{itemData.currency}}</span>
                                </p>
                                <div class="control">
        ...
        methods: {
            async onSend() {
                this.response = await this.$store.dispatch('sendBuyMessage', {
                    ...
                    price: `${this.formData.unit*this.itemData.price} ${this.itemData.currency}`,
